...
figure;
hold on
title('Polynomial Kernel one v.s. one')
plot(create_phi_ori(y_draw==0,1),create_phi_ori(y_draw==0,2),'.','Color',[1 0.7 0.7]); 
plot(create_phi_ori(y_draw==1,1),create_phi_ori(y_draw==1,2),'.','Color',[0.7 1 0.7]); 
plot(create_phi_ori(y_draw==2,1),create_phi_ori(y_draw==2,2),'.','Color',[0.7 0.7 1]); 
...
savepath_str = sprintf("./q2_poly_one_one.png");
