...
w_poly1=pinv(lambda.*eye(size(phi_poly1,2))+phi_poly1'*phi_poly1)*phi_poly1'*y_train1;
w_gauss1=pinv(lambda.*eye(size(phi_gauss1,2))+phi_gauss1'*phi_gauss1)*phi_gauss1'*y_train1;
w_sig1=pinv(lambda.*eye(size(phi_sig1,2))+phi_sig1'*phi_sig1)*phi_sig1'*y_train1;
...
w_poly2=pinv(lambda.*eye(size(phi_poly2,2))+phi_poly2'*phi_poly2)*phi_poly2'*y_train2;
w_gauss2=pinv(lambda.*eye(size(phi_gauss2,2))+phi_gauss2'*phi_gauss2)*phi_gauss2'*y_train2;
w_sig2=pinv(lambda.*eye(size(phi_sig2,2))+phi_sig2'*phi_sig2)*phi_sig2'*y_train2;
%error=0.5*sqrt(sum((y_train-phi*w).^2));
...
w_poly3=pinv(lambda.*eye(size(phi_poly3,2))+phi_poly3'*phi_poly3)*phi_poly3'*y_train3;
w_gauss3=pinv(lambda.*eye(size(phi_gauss3,2))+phi_gauss3'*phi_gauss3)*phi_gauss3'*y_train3;
w_sig3=pinv(lambda.*eye(size(phi_sig3,2))+phi_sig3'*phi_sig3)*phi_sig3'*y_train3;
%error=0.5*sqrt(sum((y_train-phi*w).^2));
...
w_poly4=pinv(lambda.*eye(size(phi_poly4,2))+phi_poly4'*phi_poly4)*phi_poly4'*y_train4;
w_gauss4=pinv(lambda.*eye(size(phi_gauss4,2))+phi_gauss4'*phi_gauss4)*phi_gauss4'*y_train4;
w_sig4=pinv(lambda.*eye(size(phi_sig4,2))+phi_sig4'*phi_sig4)*phi_sig4'*y_train4;
%error=0.5*sqrt(sum((y_train-phi*w).^2));
